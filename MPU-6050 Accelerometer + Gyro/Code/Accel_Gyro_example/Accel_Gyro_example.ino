// Tutorial at http://playground.arduino.cc/Main/MPU-6050

// Breakout board GY-521 containing an MPU-6050 chip.

// I2C Address is 0x68 (default) or when pin AD0 is LOW.
// I2C Adresss can be changed to 0x69 when pin AD0 is HIGH.

// VCC+ for the board is 3.3v - however there is a voltage regulator on board so it shouldn't really matter if you plug it into 5.0v. See the article above for details on when you probably would want to do this.


// Taken from https://github.com/janaka/Gy521-Dev-Kit/blob/master/Gy521_send_serial/Gy521_send_serial.ino
